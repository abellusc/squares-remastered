        ...
        setInterval(() => {
            ...
            if (!state.started) {
                ...
                if (state.roundsPlayed === 0) {
                    ...
                    context!.fillText(`move your mouse to COLLECT the white and blue squares`, context.canvas.width / 2, (context.canvas.height + 20) / 2);
                    context!.fillText(`AVOID the red squares`, context.canvas.width / 2, (context.canvas.height + 40) / 2);
                    context!.fillText(`double click to release some points and reduce your square size`, context.canvas.width / 2, (context.canvas.height + 60) / 2);
                    context!.fillStyle = '';
                }
                return;
            }
